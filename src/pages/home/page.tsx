      ...
      <div className="relative z-10 flex flex-col items-center pt-32 px-6 text-center">
        ...
        <h1
          ...
          style={{
            ...
            textShadow:
              "0 0 40px rgba(138, 43, 226, 0.3), 0 0 80px rgba(255, 106, 0, 0.2)",
          }}
        >
        ...
        <p className="text-base text-gray-400 max-w-2xl mb-12">
          The unified platform for intelligent voice assistants, persistent memory
          systems, and seamless automation workflows.
        </p>
